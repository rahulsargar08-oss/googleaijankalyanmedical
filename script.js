    ...
    chatBody.innerHTML = `
        <div class="chat-msg bot">
            ...
            <div class="msg-content">
                <p>Namaste! Chat history cleared. How can <strong>Jankalyan Medical's AI</strong> assist you with medicines or store information?</p>
            </div>
        </div>
    `;
}
...
async function sendMessage() {
    ...
    try {
        ...
        let botReply = '';
        if (!response.ok) {
            botReply = data.error || 'Unable to connect to AI server. Please verify store hours directly via WhatsApp (+91 86691 18742).';
        } else {
            botReply = data.reply || 'I am here to assist you with medicines, timings, and store services.';
        }
        ...
        const errorHtml = `
            <div class="chat-msg bot">
                ...
                <div class="msg-content">
                    <p>Network connection error. For immediate medicine delivery or inquiry in Sangola, please contact <strong>Mr. Siddhu Hazare</strong> at <strong>+91 86691 18742</strong>.</p>
                </div>
            </div>
        `;
